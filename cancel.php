...
<body>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="myTable" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php 
                                        $query = "SELECT * FROM form WHERE status = 'cancel'";
                                            ...
                                            $formattedTime = $dateTime->format('h:i A');
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="edit.php?id=<?= $ptw['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                        <form action="code.php" method="POST" class="d-inline" onsubmit="return confirmDelete();">
                                                            <button type="submit" name="delete_form" value="<?=$ptw['id'];?>" class="btn btn-danger btn-sm">Cancel</button>
                                                        </form>
                                                    </td>
                                                </tr>
                                                <?php
    ...
    <script>
        ...
        return confirm('Are you sure you want to cancel this project ?'); 
    }
