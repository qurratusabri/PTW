		...
		<div class="main-content" id="main-content">
			<div class="row">
				<div class="user-label">
					Welcome <strong><?= $_SESSION['username'] ?></strong> to <strong><?= ucfirst($_SESSION['user_type']) ?></strong> dashboard.
				</div>
				<div class="container mt-4">
					<div class="row">
						...
						<!-- Complete Card -->
						<div class="col-md-3 mb-2">
							<a href="complete1.php?status=completed" class="text-white text-decoration-none">
						...
						<!-- Stop Work Card -->
						<div class="col-md-3 mb-2">
							<a href="stopWork1.php?status=stopWork" class="text-white text-decoration-none">
						...
						<!-- Cancel Card -->
						<div class="col-md-3 mb-2">
							<a href="cancel1.php?status=cancel" class="text-white text-decoration-none">
